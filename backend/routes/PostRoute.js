...
const { createPost, getAllPost, likePost, createComment,  getCommentById, getPostById, deletePost, dislikePost, repost, updatePost, getTagUsers} = require("../controllers/Post");
...
router.post("/tagUsers", getTagUsers);
